...
plot (Indole_mt3)
anova_indole_Fig1<-Anova (Indole_mt3, type = "III")
...
anova_monoterpenes_Fig1 <-Anova (Monoterpenes_mt3, type = "III")
...
anova_sesquiterpenes_Fig1 <-Anova(Sesquiterpenes_mt3, type = "III")
...
plot(dmnt_mt3)
anova_DMNT_Fig1 <- Anova(dmnt_mt3, type = "III")
...
plot (tmtt_mt3)
anova_TMTT_Fig1 <-Anova (tmtt_mt3, type = "III")
...
anova (Indole_m2, Indole_m3)
plot (Indole_m3)
anova_indole_Fig2 <- Anova (Indole_m3, type = "III")
...
anova (Monoterpenes_m2, Monoterpenes_m3)
plot (Monoterpenes_m3)
anova_monoterpenes_Fig2 <- Anova (Monoterpenes_m3, type = "III")
...
anova (Sesquiterpenes_mt2, Sesquiterpenes_mt3)
plot (Sesquiterpenes_mt3)
anova_sesquiterpenes_Fig2 <- Anova (Sesquiterpenes_mt3, type = "III")
...
anova (dmnt_mt2, dmnt_mt3)
plot (dmnt_mt3)
anova_DMNT_Fig2 <- Anova(dmnt_mt3, type = "III")
...
anova (tmtt_mt2, tmtt_mt3)
plot (tmtt_mt3)
anova_TMTT_Fig2 <- Anova(tmtt_mt3, type = "III")
...
anova_indole_Fig3a <- Anova(model_Indole_3, type = "III)
plot(model_Indole_3)
...
anova_monoterpenes_Fig3a<-Anova(model_monoterpenes_3, type = "III")
...
anova_sesquiterpenes_Fig3a <- Anova(model_Sesquiterpenes_3, type = "III")
...
anova_DMNT_Fig3a <-Anova(model_DMNT_2, type = "III")
plot(model_DMNT_2)
...
anova_TMTT_Fig3a <-Anova(model_TMTT_3, type = "III")
plot(model_TMTT_3)
...
model_Indole_3 <-update(model_Indole_2, 
                       correlation=corAR1())
anova(model_Indole_2, model_Indole_3)
anova_indole_Fig3b <- Anova(model_Indole_3, type = "III")
plot(model_Indole_3)
...
model_monoterpenes_3 <- update(model_monoterpenes_2, 
                             correlation = corAR1 ())
anova(model_monoterpenes_2, model_monoterpenes_3)
anova_monoterpenes_Fig3b <-Anova(model_monoterpenes_3, type = "III")
plot(model_monoterpenes_3)
...
model_Sesquiterpenes_3<-update(model_Sesquiterpenes_2, 
                               correlation = corAR1())
anova(model_Sesquiterpenes_2, model_Sesquiterpenes_3)
anova_sesquiterpenes_Fig3b <- Anova (model_Sesquiterpenes_3, type = "III")
plot(model_Sesquiterpenes_3)
...
model_DMNT_3<-update(model_DMNT_2, 
                     correlation = corAR1 ())
anova(model_DMNT_2, model_DMNT_3)
anova_DMNT_Fig3b <- Anova(model_DMNT_2, type = "III")
plot(model_DMNT_2)
...
model_TMTT_3 <-update(model_TMTT_2, 
                     correlation = corAR1())
anova(model_TMTT_2, model_TMTT_3)
anova_TMTT_Fig3b <- Anova(model_TMTT_3, type = "III")
plot(model_TMTT_3)
...
Anova (model_hexenal_3, type = "III)
...
Anova(model_hexenol_3, type = "III")
