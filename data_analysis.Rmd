...
#1. Fig 1. Data analysis and Graphs
```{r}
data_folder <-"data"
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
Fig1_data <- read_excel (file_path, sheet = "Fig_1")
...
setwd("D:/Labtop Lenovo March 2022/1. Papers 2021-2022/Data for manuscripts/2. Crowding experiments/Manuscript 2/R_project_JCE")
...
# 2. Fig 2. Data analysis and graphs
```{r}

data_folder <-"data"
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
Fig2_data <- read_excel (file_path, sheet = "Fig_2")
...
### sesquiterpene sqrt transformed data
...
#3. Fig.3a. Data analysis and graphs
```{r}

data_folder <-"data"
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
Fig3a_data <- read_excel (file_path, sheet = "Fig_3a")
...
#4. Fig. 3b. Data analysis and graphs
```{r}
...
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
Fig3b_data <- read_excel (file_path, sheet = "Fig_3b")
...
#5. Fig 4. Data analysis and graphs
...
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
Fig4_data <- read_excel (file_path, sheet = "Fig_4")
View(Fig4_data)
...
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
Fig5_data <- read_excel (file_path, sheet = "Fig_5")
...
# 7. Fig.S5 - Cummulative emission of volatiles in Fig.1 
...
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
FigS5_data <- read_excel (file_path, sheet = "Fig_1")
...
#8. Fig. S6 - Cummulative emission of volatiles in Fig.2 
```{r}

data_folder <-"data"
file_name <- "Data.xls"
file_path <- here(data_folder, file_name)
FigS6_data <- read_excel (file_path, sheet = "Fig_2")


# Cumulative emission of volatile compounds from Fig.2 

FigS6_data <- FigS6_data %>%
  mutate(Plant = as.factor(Plant))
...
read_pptx() %>% 
  add_slide(layout = "Title and Content", master = "Office Theme") %>% 
   ph_with(dml(ggobj = FigS6), location = ph_location(type = "body", width = 7, height = 8)) %>% 
      print(target = "C:/Users/rocio/Desktop/Plots R2.pptx")
```
